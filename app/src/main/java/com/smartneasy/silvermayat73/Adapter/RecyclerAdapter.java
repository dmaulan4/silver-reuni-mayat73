package com.smartneasy.silvermayat73.Adapter;
...
public  class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder>{
    ...
    public RecyclerAdapter(Context context, List<Alumni> uploads) {
        mContext = context;
        alumni = uploads;
    }
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        Alumni currentAlumni = alumni.get(position);
        holder.nameTextView.setText(currentAlumni.getName());
        holder.descriptionTextView.setText(currentAlumni.getDescription());
        holder.dateTextView.setText(getDateToday());
        Picasso.with(mContext)
                .load(currentAlumni.getImageUrl())
